<template>
  <header class="header">
    ...
    <div
      :class="
        `main-header inner-header header-2 ${sticky ? 'sticky fadeInDown' : ''}`
      "
    >
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-xl-3 col-lg-3 col-md-4 col-6">
              ...
              <div class="logo">
                <nuxt-link to="/">
                  <h2 class="main-logo2" style="color: white;">
                    Qualityofcare
                  </h2>
                  <!-- <img
										class="main-logo2"
                  ...
                  <!-- <img
										class="sticky-logo"
										src="/assets/img/gtech.jpeg"
										data-rjs="2"
										alt="jironis"
									/> -->
                  <h2 class="sticky-logo" style="color: purple;">
                    Qualityofcare
                  </h2>
                </nuxt-link>
              </div>
                ...
                <div class="menu-wraper">
                  <nav>
                    ...
                    <div class="header-menu dosis">
                      ...
                      <ul class="main-nav" @command="changeLang">
                        {{
                          $t("home.lang")
                        }}
                        <li>
                          <nuxt-link to="/">Lang</nuxt-link>
                          <ul>
                            <li class="active">
                              <nuxt-link to="/" command="en">
                                English</nuxt-link
                              >
                            </li>
                            <li class="active">
                              <nuxt-link to="/" command="vi"
